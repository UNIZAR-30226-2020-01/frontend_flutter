...
//          SizedBox(height: 5,),
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    UsefulMethods.text('Duration: $mostrar', 10.0, 0.0, 255, 255, 255, 1.0),
                  ],
                ),
              ),
            )
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () async {
        podcastChapter.uri = await PodcastChapterDAO.reproducir(podcastChapter.url);
        _alert(context);
